...
from model.mlp import DualMlpAttention
...
class DualMlpAttentionModule(pl.LightningModule):
	...
	def __init__(self, cache_path, mode, vocab, pretrained_vectors: Union[str, torch.tensor]=None,
	             ...
	             **kwargs):
		super(DualMlpAttentionModule, self).__init__()
		...
		self.model = DualMlpAttention(pretrained_embedding=pretrained_vectors,
