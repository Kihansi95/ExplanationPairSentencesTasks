...
from model.mlp import SingleMlpAttention
...
class SingleMlpAttentionModule(pl.LightningModule):
	...
	def __init__(self, cache_path, mode, vocab, pretrained_vectors: Union[str, torch.tensor]=None,
	             ...
	             **kwargs):
		super(SingleMlpAttentionModule, self).__init__()
		...
		self.model = SingleMlpAttention(pretrained_embedding=pretrained_vectors,
